//* Funções são blocos de código que podem ser executados e reutilizados. Valores podem ser passados por uma função e a mesma retorna outro valor.
...
function dados() {
  ...
  function outrosDados() {
    var endereco = 'Rua Rio de Janeiro';
    var idade = 29;
...
dados(); //> Retorna 'Hércules, 29, Rua Rio de Janeiro, Designer'
